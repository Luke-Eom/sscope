package com.sscope.sscope.login.oauth;

import com.fasterxml.jackson.core.JsonProcessingException;
import com.fasterxml.jackson.databind.ObjectMapper;

import com.sscope.sscope.login.entity.KakaoUserInfo;
import com.sscope.sscope.login.entity.ProfileResult;
import com.sscope.sscope.login.entity.Token;
...
public class KakaoOAuth2 {
    ...
    private String getAccessToken(String authorizedCode) throws JsonProcessingException {
        ...
        Token tokenResult = objectMapper.readValue(tokenJson, Token.class);
